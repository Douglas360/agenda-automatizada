        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/register" || pathname.includes("register")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M2.2499 0.956299H15.7499C16.7062 0.956299 17.5218 1.7438 17.5218 2.70005V14.5406C17.5218 15.4968 16.7062 16.3125 15.7499 16.3125H2.2499C1.29365 16.3125 0.478027 15.525 0.478027 14.5406V2.70005C0.478027 1.7438 1.29365 0.956299 2.2499 0.956299ZM15.7499 15.0187H2.2499C2.0251 15.0187 1.77178 14.7937 1.77178 14.5406V4.75308H16.228V14.5406C16.228 14.7937 15.9752 15.0187 15.7499 15.0187Z"
                            fill=""
                          />
                          <path
                            d="M9.0002 7.79065C11.0814 7.79065 12.7689 6.1594 12.7689 4.1344C12.7689 2.1094 11.0814 0.478149 9.0002 0.478149C6.91895 0.478149 5.23145 2.1094 5.23145 4.1344C5.23145 6.1594 6.91895 7.79065 9.0002 7.79065ZM9.0002 1.7719C10.3783 1.7719 11.5033 2.84065 11.5033 4.16252C11.5033 5.4844 10.3783 6.55315 9.0002 6.55315C7.62207 6.55315 6.49707 5.4844 6.49707 4.16252C6.49707 2.840
                          65 7.62207 1.7719 9.0002 1.7719Z"
                            fill=""
                          />
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/register/user"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/register/user" && "text-white"
                              }`}
                            >
                              Usuários
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/register/ministry"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/register/ministry" &&
                                "text-white"
                              } `}
                            >
                              Ministérios
