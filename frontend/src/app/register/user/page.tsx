...
const RegisterUserPage = () => {
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Cadastro de usuário" />
      <div className="flex flex-col gap-10">
        <Link
          href="/register/user/form"
          className="inline-flex items-center justify-center gap-2.5 rounded-full bg-meta-3 px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 md:w-1/3 lg:w-1/3 lg:px-8 xl:px-10"
        >
          <span>
            <svg
